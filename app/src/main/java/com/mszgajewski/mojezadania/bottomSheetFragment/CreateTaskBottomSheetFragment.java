package com.mszgajewski.mojezadania.bottomSheetFragment;
...
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public boolean validateFields(){
        if (addTaskTitle.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(activity, "Proszę wpisać tytuł", Toast.LENGTH_SHORT).show();
            return false;
        } else if (addTaskDescription.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(activity, "Proszę wpisać opis", Toast.LENGTH_SHORT).show();
            return false;
        } else if (taskDate.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(activity, "Proszę wpisać datę", Toast.LENGTH_SHORT).show();
            return false;
        } else if (taskTime.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(activity, "Proszę wpisać czas", Toast.LENGTH_SHORT).show();
            return false;
        } else if (taskEvent.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(activity, "Proszę wpisać wydarzenie", Toast.LENGTH_SHORT).show();
            return false;
        } else {
            return true;
        }
    ...
    private void createTask(){
        class saveTaskInBackend extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                if (!isEdit){
                    DatabaseClient.getInstance(getActivity()).getAppDatabase().dataBaseAction()
            ...
            protected void onPostExecute(Void unused) {
                ...
                Toast.makeText(activity, "Wydarzenie zostało dodane", Toast.LENGTH_SHORT).show();
                dismiss();
            }
        }
    ...
    private void createAnAlarm() {
        try {
            String [] strings = taskDate.getText().toString().split("-");
            String dd = strings[0];
