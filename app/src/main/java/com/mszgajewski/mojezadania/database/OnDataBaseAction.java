...
public interface OnDataBaseAction {
    ...
    void selectDataFromAnId(int taskId);
    ...
    void updateAnExistingRow(int taskId, String taskTitle, String taskDescription, String taskDate, String taskTime, String taskEvent);
